...
async def run_retirement_agent(job_id: str, portfolio_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Create agent (returns deployment name, tools, task)
    deployment_name, tools, task = create_agent(job_id, portfolio_data, user_preferences, db)
    ...
    with trace("Retirement Agent"):
        ...
        try:
            ...
            logger.error(f"Retirement agent error: {e}")
