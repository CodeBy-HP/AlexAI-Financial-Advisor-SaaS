#!/usr/bin/env python3
"""
Test to verify LangFuse integration with Azure OpenAI for Charter agent
"""
...
async def test_langfuse_charter():
    """Test that LangFuse wrapper captures Azure OpenAI calls for charter"""
    
    print("Testing Charter Agent - LangFuse + Azure OpenAI Integration...")
    print("=" * 60)
    ...
    try:
        response = await client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": "Say 'Charter agent LangFuse integration working!' in one sentence."}
            ],
            temperature=0.7,
            max_tokens=50,
            # LangFuse-specific parameters
            name="charter-test-trace",
            metadata={"test": "charter_langfuse", "agent": "charter"}
        )
        ...
        print("You should see a trace named 'charter-test-trace'")
        print("=" * 60)
...
if __name__ == "__main__":
    asyncio.run(test_langfuse_charter())
