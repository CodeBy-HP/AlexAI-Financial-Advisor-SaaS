...
def create_agent(job_id: str, portfolio_data: Dict[str, Any], db=None):
    ...
    logger.info(f"Charter: Using Azure OpenAI deployment: {os.getenv('AZURE_OPENAI_DEPLOYMENT')}")
    ...
    # Return deployment name and task (no tools or context needed)
    return os.getenv("AZURE_OPENAI_DEPLOYMENT"), task