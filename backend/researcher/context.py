...
1. WEB RESEARCH (USE TAVILY SEARCH):
   - Use tavily_search to find current information
   - Search for specific topics like "[Company] stock price 2026" or "[Topic] latest news"
   - The search returns current web results with titles, URLs, and content
   - Use 1-3 search queries maximum - be specific and efficient
