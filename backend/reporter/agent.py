...
from agents import function_tool, RunContextWrapper, set_default_openai_client, set_default_openai_api, set_tracing_disabled
from langfuse.openai import AsyncAzureOpenAI  # Use LangFuse wrapper for automatic tracing
...
Make the report informative yet accessible to a retail investor."""
    ...
    return os.getenv("AZURE_OPENAI_DEPLOYMENT"), tools, task, context
