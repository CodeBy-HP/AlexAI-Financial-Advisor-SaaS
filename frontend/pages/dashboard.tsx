...
import { Wallet, Building2, TrendingUp, Calendar, Save, User } from "lucide-react";
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Welcome back, {user?.firstName || 'there'}! Here&apos;s your portfolio overview.</p>
        </div>
        ...
        {loading ? (
          ...
          <motion.div 
            ...
            className="bg-gradient-to-br from-primary to-primary-light rounded-xl shadow-lg p-6 text-white"
          >
            <div className="flex items-center justify-between mb-4">
              <Wallet className="w-8 h-8 opacity-80" />
              <span className="text-xs bg-white/20 px-2 py-1 rounded-full">Total Value</span>
            </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs bg-secondary/10 text-secondary px-2 py-1 rounded-full font-medium">Accounts</span>
            </div>
            <p className="text-3xl font-bold text-gray-900 mb-1">{accounts.length}</p>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs bg-success/10 text-success px-2 py-1 rounded-full font-medium">Allocation</span>
            </div>
            {pieChartData.length > 0 ? (
              <>
                ...
                <p className="text-sm text-gray-600 text-center">Diversified Portfolio</p>
              </>
            ) : (
              <p className="text-sm text-gray-500 text-center">No positions yet</p>
            )}
          </motion.div>
          ...
          >
            ...
            <p className="text-3xl font-bold text-gray-900 mb-1">
              {lastAnalysisDate ? new Date(lastAnalysisDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric' }) : "Never"}
            </p>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Manage your profile and retirement goals</p>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                  placeholder="100,000"
                />
              </div>
            </div>
