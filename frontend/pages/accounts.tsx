...
import { Plus, RotateCcw, DollarSign, TrendingUp, Eye } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 mb-6 border border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Investment Accounts</h2>
              <p className="text-gray-600">Manage your investment accounts and portfolios</p>
            </div>
            <div className="flex flex-wrap gap-2">
              <button
                onClick={() => setShowAddModal(true)}
                className="flex items-center gap-2 bg-gradient-to-r from-primary to-primary-light hover:shadow-lg text-white px-5 py-2.5 rounded-xl font-semibold transition-all hover:scale-105"
              >
              ...
              {accounts.length === 0 && !loading && (
                <button
                  ...
                  className="flex items-center gap-2 bg-gradient-to-r from-accent to-accent-light hover:shadow-lg text-white px-5 py-2.5 rounded-xl font-semibold transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
              ...
              {accounts.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-2 bg-gray-600 hover:bg-gray-700 text-white px-5 py-2.5 rounded-xl font-semibold transition-all disabled:opacity-50"
                >
          ...
          {loading ? (
            ...
            <>
              ...
              <motion.div 
                ...
                className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl p-6 mb-6 border border-gray-200"
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-4 bg-white rounded-xl shadow-sm">
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {formatCurrency(calculatePortfolioTotal())}
                    </p>
                  </div>
                  <div className="text-center p-4 bg-white rounded-xl shadow-sm">
                    <div className="flex justify-center mb-2">
                  ...
                  <div className="text-center p-4 bg-white rounded-xl shadow-sm">
                    <div className="flex justify-center mb-2">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-success to-green-500 flex items-center justify-center">
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr className="border-b border-gray-200">
                      <th className="text-left py-4 px-4 font-semibold text-gray-900">Account Name</th>
                      <th className="text-left py-4 px-4 font-semibold text-gray-900 hidden md:table-cell">Purpose</th>
                      <th className="text-right py-4 px-4 font-semibold text-gray-900">Positions</th>
                      <th className="text-right py-4 px-4 font-semibold text-gray-900">Cash</th>
                      <th className="text-right py-4 px-4 font-semibold text-gray-900">Total Value</th>
                        ...
                        >
                          <td className="py-4 px-4">
                            <div>
                              ...
                              <p className="text-xs text-gray-500 md:hidden mt-1">{account.account_purpose}</p>
                            </div>
                          </td>
                          ...
                          <td className="py-4 px-4 text-right">
                            <div>
                              <p className="font-semibold text-gray-900">{account.positions?.length || 0}</p>
                              {positionsValue > 0 && (
                          ...
                          <td className="py-4 px-4 text-right font-medium text-gray-900">
                            {formatCurrency(Number(account.cash_balance))}
                          </td>
                          <td className="py-4 px-4 text-right">
                            <p className="font-bold text-primary">
                              {formatCurrency(calculateAccountTotal(account))}
                            </p>
                          </td>
                          <td className="py-4 px-4">
